...
const PersonalCare = () => {
  ...
  const [filteredProducts, setFilteredProducts] = useState(personalCareProducts);
  ...
  const handleSort = (type) => {
    ...
    setSortBy(type);
    let sorted = [...personalCareProducts];
  ...
  const handleRatingFilter = (rating) => {
    ...
    const filtered = personalCareProducts.filter(product => product.rating === rating);
